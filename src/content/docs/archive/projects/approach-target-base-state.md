...
3. Start coding up the outline of the ApproachTargetBaseState. After everyone understands this state, split into smaller groups to work on the ApproachPostState, [LongRangeState](/archive/projects/second-camera-integration), and [ApproachObjectState](/archive/projects/approach-object-state) states.