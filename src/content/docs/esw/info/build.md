...
libraries) see the [Build System](/esw/reference/build) reference.
...
[STM32Cube\*](/esw/getting-started/stm32cube) for details.
...
to build (see
[Debugging with STM32CubeIDE](/esw/getting-started/stm32cube#debugging-with-stm32cubeide)).
...
- Every directory named in `/etc/profile.d/mrover-esw.sh` still exists, **and** is actually on the
  ...
  [STM32Cube\*](/esw/getting-started/stm32cube#downloading-and-installing-the-cube-tools-linux)
...
[Python Tools](/esw/reference/python).

| Module | Purpose |
| --- | --- |
| [`esw.can`](/esw/reference/python/can) | CAN bus access, DBC parsing, CAN header generation |
| [`esw.config`](/esw/reference/python/config) | board register definitions and value packing |
| [`esw.cubemx`](/esw/reference/python/cubemx) | CubeMX project generation and CMake rendering |
| [`esw.stlink`](/esw/reference/python/stlink) | ST-LINKv3 serial log monitoring |
| [`esw.visualization`](/esw/reference/python/visualization) | live plotting for bench testing |
