...
| --- | --- | --- | --- |
| [ABS](/esw/projects/boards/abs) | `src/abs` | absolute encoder | `config/abs.yaml` |
| [BMC](/esw/projects/boards/bmc) | `src/bmc` | brushed motor controller | `config/bmc.yaml` |
| [LIM](/esw/projects/boards/lim) | `src/lim` | standalone limit switch reporter | `config/lim.yaml` |
| [PDB](/esw/projects/boards/pdlb) | `src/pdlb` | power distribution and autonomy status LED | none |
| [SCI](/esw/projects/boards/science) | `src/science` | atmospheric sensor suite | none |
...
`0x10`. See [esw.can](/esw/reference/python/can) for the host-side API.
...
See [Configuration](/esw/reference/config) for how registers are defined and pushed.
