...
| CAN | FDCAN1 | |
| Logging | LPUART1 (DMA) | see [esw.stlink](/esw/reference/python/stlink) |
...
28 bytes total. See [Register Definitions](/esw/reference/config/schema) and
