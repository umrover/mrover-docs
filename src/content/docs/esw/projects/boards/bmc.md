---
title: "Brushed Motor Controller (BMC)"
---
...
background on the motors themselves see [Brushed DC Motors](/esw/info/brushed).
...
See [Register Definitions](/esw/reference/config/schema) and
[CAN Configuration Interface](/esw/reference/config/can-interface).
