...
![opened "Code" tab with boxes showing how to copy the SSH URL](/esw-dev/servo/copy-git-repo.webp)
...
![timer 1 configuration in stm32cubeide](/esw-dev/servo/servo-timer-config.webp)
...
![breadboard](/esw-dev/servo/breadboard_diagram.webp)
