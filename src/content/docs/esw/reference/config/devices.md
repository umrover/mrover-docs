...
To push one of these to a board, see [CAN Configuration Interface](/esw/reference/config/can-interface).
...
See [Brushless Motors](/esw/info/brushless) for background on the controllers themselves.
