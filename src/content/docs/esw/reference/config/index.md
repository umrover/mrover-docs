...
- [Register Definitions](/esw/reference/config/schema): the `config/*.yaml` schema and the generated C++ API
- [Device Values](/esw/reference/config/devices): the `rover/` tree, and the separate moteus format
- [CAN Configuration Interface](/esw/reference/config/can-interface): pushing values to a board
- [Boards](/esw/projects/boards): per-board registers and CAN messages
...
[Device Values](/esw/reference/config/devices#moteus-controllers-cfg).
