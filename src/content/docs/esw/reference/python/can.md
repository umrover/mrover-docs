...
[Generated Libraries](/esw/reference/build/codegen).
...
Per-board message tables are on the [board pages](/esw/projects/boards).
...
See [Continuous Integration](/esw/reference/build/ci#releaseyml).
