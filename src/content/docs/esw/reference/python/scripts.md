...
set every time. See [Project Anatomy](/esw/reference/build/project-layout#linked-libraries).
...
See [esw.stlink](/esw/reference/python/stlink).
...
See [CAN Configuration Interface](/esw/reference/config/can-interface).
