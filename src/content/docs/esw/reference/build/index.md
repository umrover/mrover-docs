...
[Build Script Internals](/esw/reference/build/build-script).
...
[Project Anatomy](/esw/reference/build/project-layout).
...
- [Project Anatomy](/esw/reference/build/project-layout): what is in a project directory, and what you may edit
- [Toolchain and Presets](/esw/reference/build/toolchain): compiler selection, `Debug` vs `Release`
- [Generated Libraries](/esw/reference/build/codegen): how the DBC and config headers get built
- [Build Script Internals](/esw/reference/build/build-script): what `build.sh` actually runs
- [Continuous Integration](/esw/reference/build/ci): what CI builds, and in what container
